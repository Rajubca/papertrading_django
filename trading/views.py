...
import pandas as pd
from .forms import UserRegisterForm, UserUpdateForm, ProfileUpdateForm, PortfolioForm, TradeForm, WatchlistForm
from .models import Portfolio, Stock, Holding, Transaction, PortfolioReport, Watchlist, HoldingReport
import json
